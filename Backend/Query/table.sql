...
ALTER TABLE CONSULTS
    ADD SELECTED_TIME VARCHAR2(
        50
    );

ALTER TABLE CONSULTS MODIFY SELECTED_DATE NOT NULL;

ALTER TABLE CONSULTS MODIFY SELECTED_TIME NOT NULL;
...
--MODIFYING ALL PRODUCT RELATED TABLES--
ALTER TABLE PAYS
DROP PRIMARY KEY;
commit;
...
ALTER TABLE PAYS DROP COLUMN PRICE_WITH_VAT;
ALTER TABLE PAYS DROP COLUMN AMOUNT;
commit;
