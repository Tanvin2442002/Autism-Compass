...
CREATE TABLE HEALTH_PROFESSIONAL(
    ...
    FIELD_0F_SPEC VARCHAR2(255) NOT NULL,
    NAME_OF_HOSPITAL VARCHAR2(255) NOT NULL,
    VISIT_TIME VARCHAR2(255) NOT NULL,  -- Added column for Visit Time
    ADDRESS ADDR,
    CONSTRAINT ADDRESS_CITY_NOT_NULL CHECK (ADDRESS.CITY IS NOT NULL),
    CONSTRAINT ADDRESS_STREET_NOT_NULL CHECK (ADDRESS.STREET IS NOT NULL),
    CONSTRAINT ADDRESS_POSTAL_CODE_NOT_NULL CHECK (ADDRESS.POSTAL_CODE IS NOT NULL)
);
