              ...
              <>
                ...
                >
                  <Link
                    ...
                    className={`navbar-link ${
                      location.pathname.startsWith("/doctor/booked") ||
                  ...
                  {isDocHovered && (
                    <div className="products-dropdown">
                      <Link
                        to="/HealthProfessionals"
                        className={`navbar-link ${
                          location.pathname == "/HealthProfessionals"
                            ? "active"
                            : ""
                        }`}
                      >
                      ...
                      <Link
                        to="/doctor/feedback"
                        className={`navbar-link ${
                          location.pathname.startsWith("/doctor/feedback")
                            ? "active"
                            : ""
                        }`}
                      >
                ...
                >
                  <Link
                    to="/therapy"
                    className={`navbar-link ${
                      location.pathname.startsWith("/therapy") ? "active" : ""
                    }`}
                  >
                    Therapy
                  </Link>
                  {isHovered && (
                    <div className="products-dropdown">
                      ...
                      <Link
                        to="/therapy/booked"
                        className={`navbar-link ${
                          location.pathname.startsWith("/therapy/booked")
                            ? "active"
                            : ""
                        }`}
                      >
                      ...
                      <Link
                        to="/therapy/org"
                        className={`navbar-link ${
                          location.pathname.startsWith("/therapy/org")
                            ? "active"
                            : ""
                        }`}
                      >
                ...
                >
                  <Link
                    to="/disorder"
                    className={`navbar-link ${
                      location.pathname === "/disorder" ? "active" : ""
                    }`}
                  >
                    Disorder
                  </Link>
              ...
              <>
                ...
                >
                  <Link
                    to="/parent-child"
                    className={`navbar-link ${
                      location.pathname === "/parent-child" ? "active" : ""
                    }`}
                  >
                    Child
                  </Link>
                  ...
                  {isProductsHovered && (
                    <div className="products-dropdown">
                      ...
                      <Link
                        to="/products/orders"
                        className={`navbar-link ${
                          location.pathname.startsWith("/products/orders")
                            ? "active"
                            : ""
                        }`}
                      >
