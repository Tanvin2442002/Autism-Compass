  ...
  return (
    <div className='booking'>
      ...
      <div className='booking-heading'>
        <h1>Details for Booking Therapy</h1>
        <div className="booking-therapy">
          <div className="organization-details">
            <h2>Organization Details</h2>
            <img src='https://png.pngtree.com/png-clipart/20240404/original/pngtree-flat-hospital-icon-building-vector-png-image_14747636.png' alt="Organization" />
            {orgDetails && orgDetails[0] && (
              <>
                <div className="org-info">
                  <h3>{orgDetails[0].NAME}</h3>
                </div>
                <div className="org-info">
                  <i className='bx bxs-phone bx-sm'></i>
                  <p>{orgDetails[0].CONTACT_NO}</p>
                </div>
                <div className="org-info">
                  <i className='bx bxs-envelope bx-sm'></i>
                  <p>{orgDetails[0].EMAIL}</p>
                </div>
                <div className="org-info">
                  <i className='bx bxs-home bx-sm'></i>
                  <p>{orgDetails[0].STREET} , {orgDetails[0].CITY} , {orgDetails[0].POSTAL_CODE}</p>
                </div>
              </>
            )}
          </div>
