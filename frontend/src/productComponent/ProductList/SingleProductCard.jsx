...
const SingleProductCard = ({ itemDetails, handleClick}) => {
   return (
      <StyledWrapper>
         <div className="card">
            ...
            <div className="card-footer">
               <span className="text-title">${itemDetails.PRICE}</span>
               <div className="card-button" onClick={() => handleClick(itemDetails.PR_ID)}>
                  <svg  
